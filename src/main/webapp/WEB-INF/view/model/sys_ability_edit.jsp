                    ...
                    <div class="col-sm-8">
                        <select class="form-control sp"   id="serial" name="serial" required="required">
                            ...
                            <c:forEach items="${xlList}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==as.serial}">selected</c:if>>${dic.detail}</option>
                            </c:forEach>
                        </select>
                    </div>
				</div>
                    ...
                    <div class="col-sm-8">
                        <select class="form-control sp"  name="thelevel"   id="thelevel" required="required">
                            ...
                            <c:forEach items="${jbList}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==as.thelevel}">selected</c:if>>${dic.detail}</option>
                            </c:forEach>
                        </select>
                    </div>
				</div>
