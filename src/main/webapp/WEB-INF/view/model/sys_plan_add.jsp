        ...
        <form id="planForm" class="form-horizontal form" method="POST">
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control"  name="serial"  required="required">
                            <option></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8" >
                        <div class="input-group input-large date-picker input-daterange"   data-date-format="yyyy-mm-dd">
                            <input type="text"  id="starttime" class="form-control" name="starttime" required="required">
                            <span class="input-group-addon"> 至 </span>
                            <input type="text" id="endtime" class="form-control" name="endtime" required="required" > </div>
                    </div>
                </div>
...
<script type="text/javascript" src="${ctx}/static/model/sys_plan_add.js"></script>
